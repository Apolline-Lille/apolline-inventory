...
class CardsManagerSpec extends Specification with Mockito {
  ...
  "When method printForm is called, CardsManager" should{
    "print an empty form" in new WithApplication{
      ...
      content must contain("<input type=\"text\" id=\"id\" name=\"id\" value=\"\" class=\"form-control\" readonly=\"readonly\"/>")
      content must contain("<input type=\"date\" id=\"acquisition\" name=\"acquisition\" value=\"\" class=\"form-control\" readonly=\"readonly\"/>")
