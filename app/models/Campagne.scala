 ...
 */
case class Campagne(_id:BSONObjectID=BSONObjectID.generate,nom:String,types:String,collectUrl:String,version:Int,dataToken:String,conditions:List[BSONObjectID],delete:Boolean=false)
